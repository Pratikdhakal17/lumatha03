      ...
      <div className={`fixed inset-0 z-50 transition-opacity flex ${drawerOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`} style={{background: 'rgba(0,0,0,0.75)'}}>
        <div className={`drawer h-full shadow-xl transition-transform duration-250 ${drawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="dgrid">
            ...
            <div className="dgi" onClick={() => { navigate('/music-adventure'); setDrawerOpen(false); }}><svg viewBox="0 0 24 24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg><span className="dglbl">AB Dev</span></div>
          </div>
          <div className="dfoot">
